import 'package:easymoney/screens/pay/international/countries.dart';
...
class PayeeListInternational extends StatelessWidget {
  @override
        ...
        body: ListView(
          children: <Widget>[
            Container(
              ...
              child: RaisedButton(
                onPressed: () {
                  pushNewScreen(context, screen: Countries());
                },
                elevation: 0.0,
                color: Colors.white,
                child: Column(
